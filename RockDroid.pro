...
#CONFIG += playstation3
#CONFIG += psp           # try to replicate the exact same behavior of the makefile.psp
#CONFIG += open_pandora
#CONFIG += wii           # missing rotozoom, check if we can remove it (I think it is used for missiles)
